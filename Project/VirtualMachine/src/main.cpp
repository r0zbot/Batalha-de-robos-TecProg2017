...
int main() {
	...
	const vector<vector<int>> terrain {
		{3, 1, 3, 4, 3, 0, 0, 1, 1, 1, 1, 1, 1, 2, 2, 2, 0, 2, 4, 1}, 
		{3, 2, 0, 0, 3, 3, 0, 0, 4, 0, 1, 4, 1, 0, 0, 4, 4, 2, 3, 3}, 
		{2, 2, 2, 0, 1, 4, 3, 1, 4, 2, 3, 4, 3, 2, 1, 3, 1, 4, 0, 3}, 
		{3, 2, 0, 0, 3, 2, 1, 0, 2, 2, 4, 3, 0, 4, 2, 0, 1, 4, 3, 0}, 
		{4, 0, 3, 2, 3, 3, 0, 2, 2, 1, 1, 2, 1, 3, 4, 0, 4, 2, 1, 3}, 
		{4, 1, 4, 3, 1, 2, 1, 3, 4, 4, 2, 1, 1, 1, 3, 0, 1, 0, 2, 3}, 
		{3, 3, 2, 1, 3, 3, 0, 3, 0, 4, 2, 3, 2, 0, 4, 4, 4, 4, 3, 4}, 
		{1, 3, 3, 2, 3, 2, 2, 3, 4, 3, 2, 0, 4, 0, 0, 3, 1, 4, 3, 2}, 
		{4, 2, 3, 0, 4, 4, 3, 4, 3, 0, 0, 4, 1, 3, 0, 2, 3, 2, 4, 2}, 
		{4, 2, 0, 0, 4, 2, 2, 4, 4, 0, 0, 1, 0, 3, 1, 0, 4, 2, 0, 4}, 
	};
	...
	const vector<Instruction> prog1 ({
        ...
        ,Instruction(Code::RET,make_shared<Number>(0))
        ,Instruction(Code::NOP,make_shared<Number>(0))
        ,Instruction(Code::JMP,make_shared<Number>(18))
        ,Instruction(Code::PUSH,make_shared<Number>(10))
        ...
        ,Instruction(Code::ENTRY,make_shared<Number>(6))
        ,Instruction(Code::CALL,make_shared<Number>(20))
        ,Instruction(Code::ADD,make_shared<Number>(0))
